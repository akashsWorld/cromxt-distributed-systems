...
public class AvailableRouteDiscovererService {
    ...
    @KafkaListener(topics = "${ROUTE_SERVICE_BUCKET_HEARTBEAT_TOPIC}",containerFactory = "bucketsHeartbeatKafkaListenerContainerFactory")
...
//                        .build());
    ...
    @KafkaListener(topics = "${ROUTE_SERVICE_BUCKET_INFORMATION_UPDATE_TOPIC}",containerFactory = "bucketsUpdateKafkaListenerContainerFactory")
